...
class DeetsPage extends React.Component {
  ...
  render() {
    const deets = this.props.state.deets;
      ...
      <div className="deetspage">
        ...
        <Grid centered>
          <Grid.Column computer={8} mobile={16}>
                    ...
                    <Grid.Column>
                      <Statistic.Group size="tiny">
                        <Statistic color="green">
                          <Statistic.Value>
                            {(deets.user.total.success * 100) / (deets.user.total.attempted - deets.user.total.pending)}%
                          </Statistic.Value>
                        ...
                        <Statistic color="red">
                          <Statistic.Value>
                            {(deets.user.total.fail * 100) / (deets.user.total.attempted - deets.user.total.pending)}%
                          </Statistic.Value>
                          <Statistic.Label>OF GOALS</Statistic.Label>
                    ...
                    <Grid.Column>
                      <Statistic.Group size="mini">
                        <Statistic horizontal>
                          <Statistic.Value>
                            {(deets.global.total.success * 100) / (deets.global.total.attempted - deets.global.total.pending)}%
                          </Statistic.Value>
            ...
            <Segment.Group raised>
              <Segment>
                <Statistic horizontal size="tiny" label="Total Stairs"
                  value={deets.user.floors.amountComplete - deets.user.floors.amountStart}
                />
              </Segment>
              <Segment>
                <Statistic horizontal size="tiny" label="Total Steps" 
                  value={deets.user.steps.amountComplete - deets.user.steps.amountStart}
                />
              </Segment>
              <Segment>
                <Statistic horizontal size="tiny" label="Total Miles"
